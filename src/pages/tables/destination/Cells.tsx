  ...
  return (
    <Popover ref={ref} className={className} style={{ left, top }} full>
      <Dropdown.Menu onSelect={handleSelect}>
        <Dropdown.Item eventKey={1}>Vue Profile</Dropdown.Item>
        <Dropdown.Item eventKey={2}>Update Destination</Dropdown.Item>
        <Dropdown.Item eventKey={3}>Block Destination</Dropdown.Item>
      </Dropdown.Menu>
    </Popover>
  );
};
