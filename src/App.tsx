...
import TranportPage from './pages/tables/transport';
import DestinationPage from './pages/tables/destination';
      ...
      <CustomProvider locale={enGB}>
        <Routes>
          <Route path="/" element={<Frame navs={appNavs} />}>
            ...
            <Route path="table-destination" element={<DestinationPage />} />
